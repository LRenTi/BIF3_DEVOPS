...
\begin{figure}[H]
	...
	\caption{LDAP zu Access Contoll List hinzugefügt}
	\label{fig:LDAP zu Access Contoll List hinzugefügt}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{LDAP im DNS Lookup hinzugefügt}
	\label{fig:LDAP im DNS Lookup hinzugefügt}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{LDAP im DNS Reverse-Lookup hinzugefügt}
	\label{fig:LDAP im DNS Reverse-Lookup hinzugefügt}
\end{figure}
...
Nun müssen wir ein gültiges Passwort für den Benutzer Samuel festlegen. Wir haben bisher nur einen Platzhalter verwendet, um ein Konto ohne Passwort zu erstellen.
