...
\begin{table}[h!]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l|l|l|l|l|}
			...
			Preferred DNS Server   & Ubuntu Server & bind9, bind9utils & BIND 9 / Ubuntu 24.04 LTS    & T3.micro                 \\ \hline
			Alternative DNS Server & Ubuntu Server & bind9, bind9utils & BIND 9 / Ubuntu 24.04 LTS    & T3.micro                 \\ \hline
