...
\begin{verbatim}
		ssh ubuntu@98.81.217.50 ----IP ÜBERPRÜFEN
\end{verbatim}
Public IP vom EC2 GitLab Server und vom GitLab Server zu einem Private Subnet Server springen.

\begin{verbatim}
	ssh ubuntu@10.0.2.252(Private IP des DNS-Primary EC2 Servers)  -ÄNDER AUF RICHTIG
\end{verbatim}
...
\begin{verbatim}
		acl "trusted" {
						10.0.2.252;   --ÄNDERN AUF RICHTIGE
						10.0.2.217;
						10.0.1.77;
						10.0.2.148;
						10.0.2.146;
...
\begin{verbatim}
		zone "ilovedevops.com" {
		type primary;
		file "/etc/bind/zones/db.ilovedevops.com"; 
		allow-transfer { 10.0.2.217; }; 
		};
\end{verbatim}
...
\begin{verbatim}
		zone "1.0.10.in-addr.arpa" {
					...
					allow-transfer { 10.0.2.217; }; # ns2 private IP address - secondary
		};
\end{verbatim}
...
\begin{verbatim}
		sudo nano /etc/bind/zones/db.ilovedevops.com
\end{verbatim}
...
\begin{verbatim}
		...
		;
		$TTL 604800
		@ IN SOA ns1.ilovedevops.com. admin.ilovedevops.com. (
						3 ; Serial
						604800 ; Refresh
						86400 ; Retry
						2419200 ; Expire
		...
		; name servers - NS records
				IN	NS 	ns1.ilovedevops.com.
				IN 	NS 	ns2.ilovedevops.com.

		; name servers - A records
		ns1.ilovedevops.com. 	IN	A		10.0.2.252     -ÄNDERN AUF RICHTIG
		ns2.ilovedevops.com. 	IN	A		10.0.2.217

		; 10.0.0.0/16 - A records
		gitlab.ilovedevops.com. IN 	A 	10.0.1.77
		glrunner.ilovedevops.com. 	IN 	A 	10.0.2.148
		ldap.ilovedevops.com. 	IN	 A 	10.0.2.146
\end{verbatim}
...
Das bedeutet, wenn der DNS eine Abfrage nach einer IP-Adresse erhält, z. B. 10.0.1.77, wird er in der Reverse-Zonendatei(en) nachschauen, um den entsprechenden FQDN zu ermitteln, z. B. gitlab.ilovedevops.com in diesem Fall.
...
\begin{verbatim}
		...
		IN NS ns2.ilovedevops.com.
		; PTR Records
		77 IN PTR gitlab.ilovedevops.com. ; 10.0.1.77
\end{verbatim}

\begin{itemize}
	\item ilovedevops.com. oder @ : Wurzel der Zone. Dies gibt an, dass die Zonendatei für die Domain ilovedevops.com bestimmt ist.
...
\item ns1.ilovedevops.com.: Definiert den primären Nameserver für diese Domain.

\item admin.ilovedevops.com.: E-Mail-Adresse des Administrators für diese Zone. Das „@“ wird in der E-Mail-Adresse durch einen Punkt ersetzt.
...
\begin{verbatim}
		...
		;
		$TTL 604800
		@ IN SOA ilovedevops.com. admin.ilovedevops.com. (
				1 ; Serial 
				604800 ; Refresh
				86400 ; Retry
				2419200 ; Expire
		...
		IN NS ns2.ilovedevops.com.
		; PTR Records
		252 IN PTR ns1.ilovedevops.com. ; 10.0.2.252			--ÄNDERN AUF RICHTIG
		217 IN PTR ns2.ilovedevops.com. ; 10.0.2.217
		148 IN PTR glrunner.ilovedevops.com. ; 10.0.2.148
		146 IN PTR ldap.ilovedevops.com. ; 10.0.2.146
\end{verbatim}
...
\subsection{Wechsel zum öffentlichen GitLab-Server}
...
Im Anschluss wird Docker gemäß der offiziellen Dokumentation installiert. Nach erfolgreichem Test mit dem \texttt{hello-world}-Image folgen wir der GitLab-Dokumentation.
...
GitLab ist nach kurzer Zeit unter \texttt{http://54.89.164.241} erreichbar. Der Standard-Benutzername lautet \texttt{root}, das Passwort kann mit folgendem Befehl abgerufen werden:
