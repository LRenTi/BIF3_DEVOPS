...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{data/Choose_Region.png}
...
Jetzt aktualisieren wir den neuen Routing Table, damit das Gateway Internetzugriff hat.
...
\subsubsection{Routing Table}
Wie beim Public Subnet muss man nun den Routing Table aktualisieren.
\begin{figure}[h!]
	\centering
...
GitLab-Instanz-URL: Hier geben wir http://gitlab.semesterDevOps.com ein. Diese URL wird von unserem DNS-Server auf den Server aufgelöst, auf dem die GitLab-Instanz läuft.
...
\section{Integration von LDAP mit GitLab}
Als Nächstes integrieren wir LDAP in GitLab. Dazu folgen wir der offiziellen Dokumentation.
...
Fertig! Benutzer können sich nun mit ihrer LDAP-UID und ihrem Passwort anmelden.
